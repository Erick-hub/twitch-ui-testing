...
driver.find_element(
    By.CSS_SELECTOR, f'a[href*="/search?term={url_search_game_name}&type=channels"]').click()
...
driver.execute_script(
    "arguments[0].scroll({top: arguments[0].scrollHeight, behavior: 'smooth'})", div_scroll)
time.sleep(1)
driver.execute_script(
    "arguments[0].scroll({top: arguments[0].scrollHeight, behavior: 'smooth'})", div_scroll)
time.sleep(1)
...
try:
    ...
    content_warning_button = driver.find_element(
        By.XPATH, "//*[text()='Start Watching']")
...
WebDriverWait(driver, 5).until(
    EC.presence_of_element_located(
        (By.XPATH, "//*[text()='Welcome to the chat room!']")), 'Video loaded'
)
